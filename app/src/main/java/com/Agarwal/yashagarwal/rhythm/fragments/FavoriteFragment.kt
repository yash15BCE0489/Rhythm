...
import com.Agarwal.yashagarwal.rhythm.adapters.FavouriteContentAdapter
...
class FavouriteFragment : Fragment() {
    ...
    var favouriteDatabase: RhythmDatabase? = null
    ...
    override fun onCreateView(inflater: LayoutInflater?, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        ...
        favouriteDatabase = RhythmDatabase(activity)
    ...
    fun display_favorites_by_searching() {
        if (favouriteDatabase?.checkSize() as Int > 0) {
            ...
            _getSongs = (favouriteDatabase as RhythmDatabase).queryDBforList()
