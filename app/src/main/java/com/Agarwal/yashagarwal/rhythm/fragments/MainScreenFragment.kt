...
import com.Agarwal.yashagarwal.rhythm.R.id.action_sort_recent
import com.Agarwal.yashagarwal.rhythm.models.Songs
import com.Agarwal.yashagarwal.rhythm.adapters.MainScreenAdapter
import com.Agarwal.yashagarwal.rhythm.fragments.MainScreenFragment.Statified.mMediaPlayer
    ...
    fun bottomBarClickHandlers() {
        ...
        playPauseButton?.setOnClickListener({
            if (playPauseHelper?.isPlaying as Boolean) {
                ...
                playPauseHelper?.TrackPosition = SongPlayingFragment.Statified.mediaPlayer?.currentPosition!!
                playPauseHelper?.isPlaying = false
